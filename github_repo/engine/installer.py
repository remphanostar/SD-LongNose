...
from environment_management.venv_manager import VenvManager
from environment_management.file_system import FileSystem
...
class ApplicationInstaller:
    ...
    def __init__(self, base_path: str = "/workspace"):
        ...
        self.venv_manager = VenvManager(base_path)
